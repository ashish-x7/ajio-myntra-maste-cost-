                ...
                <div className="relative">
                  ...
                  />
                   <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1.5 pointer-events-none">
                     <span className="text-forest-leaf/40 font-black text-[8px] italic">₹{((tpPrice * (buffers as any)[key]) / 100).toFixed(0)}</span>
                     <span className="text-forest-leaf/20 font-black text-[8px]">%</span>
                   </div>
                </div>
              </div>
            ))}
